...
The next step is to check for correlation between variables. Some selected features are plotted in a scatter plot against "classe". Also few histograms are plotted for continuous variables to see if pre processing is necessary. 
```{r}
